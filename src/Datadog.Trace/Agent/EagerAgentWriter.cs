...
namespace Datadog.Trace.Agent
{
    internal class EagerAgentWriter : IAgentWriter
    {
        ...
        public EagerAgentWriter(IApi api, IStatsd statsd)
            : this(api, statsd, automaticFlush: true)
        {
        }

        internal EagerAgentWriter(IApi api, IStatsd statsd, bool automaticFlush)
        {
            _api = api;
            _statsd = statsd;
            ...
            _binaryBuffer = new BinaryBuffer(_api);
        }
        ...
        private void SerializeTraces(Span[] traces)
        {
            _binaryBuffer.Push(traces);
        }
